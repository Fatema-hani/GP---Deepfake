...
def find_best_frame(source, driving, cpu=True):
    ...
    for i, image in tqdm(enumerate(driving)):
        ...
        if new_norm < norm:
            ...
            frame_num = i
    return frame_num
def fake_it(source_image,driving_video,config,checkpoint,relative=True,adapt_scale=True,cpu=True,result_video="./result.mp4",best_frame=None,find_best_frame=None):
...
if __name__=="__main__":
    fake_it(driving_video="videos/0.mp4",source_image="images/00.png" ,config="config/vox-adv-256.yaml",checkpoint="vox-adv-cpk.pth.tar")
